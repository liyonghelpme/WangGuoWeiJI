class NewChallengeWin extends MyNode
{
    ...
    function initView()
    {
        ...
        var temp;
        var sca;
temp = bg.addsprite("dialogRoundOver.png", ARGB_8888).anchor(50, 50).pos(405, 206).size(434, 317).color(100, 100, 100, 100);
temp = bg.addsprite(("round" + str(param["star"])) + "Star.png", ARGB_8888).anchor(0, 0).pos(354, 130).size(109, 45).color(100, 100, 100, 100);
bg.addlabel(getStr("congrateYouGet", null), getFont(), 19).anchor(0, 50).pos(254, 193).color(64, 32, 32);
temp = bg.addsprite("dialogPrincess.png", ARGB_8888).anchor(0, 0).pos(536, 183).size(97, 157).color(100, 100, 100, 100);
...
temp = bg.addsprite("roundWin.png", ARGB_8888).anchor(50, 50).pos(414, 89).color(100, 100, 100, 100);
bg.addlabel(str(param["reward"]["silver"]), getFont(), 20).anchor(0, 50).pos(301, 229).color(18, 11, 6);
temp = bg.addsprite("silver.png", ARGB_8888).anchor(0, 0).pos(262, 215).size(30, 30).color(100, 100, 100, 100);
bg.addlabel(str(param["reward"]["crystal"]), getFont(), 20).anchor(0, 50).pos(301, 262).color(18, 11, 6);
temp = bg.addsprite("crystal.png", ARGB_8888).anchor(0, 0).pos(265, 249).size(29, 29).color(100, 100, 100, 100);
bg.addlabel(str(param["score"]), getFont(), 20).anchor(0, 50).pos(302, 295).color(18, 11, 6);
temp = bg.addsprite("dialogRankCup.png", ARGB_8888).anchor(0, 0).pos(266, 284).size(31, 26).color(100, 100, 100, 100);
    }
    function finishNew()
    {
