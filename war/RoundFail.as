...
temp = bg.addsprite("roundFail.png", ARGB_8888).anchor(50, 50).pos(415, 93).color(100, 100, 100, 100);
temp = bg.addsprite("roundTip.png", ARGB_8888).anchor(0, 0).pos(206, 142).size(64, 47).color(100, 100, 100, 100);
