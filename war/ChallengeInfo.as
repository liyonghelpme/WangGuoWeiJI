class ChallengeInfo extends MyNode
{
    ...
    function initView()
    {
        ...
        bg.addlabel(scene.user["name"], "fonts/heiti.ttf", 24).anchor(0, 50).pos(69, 32).color(100, 100, 100);
        bg.addlabel(getStr("challengeDefense", ["[NUM]", str(scene.user["cityDefense"])]), "fonts/heiti.ttf", 15).anchor(0, 50).pos(220, 34).color(100, 100, 100);

        bg.addlabel(str(scene.user["level"]), "fonts/heiti.ttf", 13).anchor(50, 50).pos(46, 32).color(0, 0, 0);

        bg.addlabel(str(-scene.user["failScore"]), "fonts/heiti.ttf", 20).anchor(0, 50).pos(112, 112).color(94, 7, 5);

        temp = bg.addsprite("dialogRankCup.png").anchor(0, 0).pos(79, 102).size(25, 22).color(100, 100, 100, 100);
        bg.addlabel(getStr("failCost",  null), "fonts/heiti.ttf", 15).anchor(0, 50).pos(33, 113).color(100, 100, 100);
        bg.addlabel(str(scene.user["silver"]), "fonts/heiti.ttf", 20).anchor(0, 50).pos(105, 81).color(100, 100, 100);

        temp = bg.addsprite("silver.png").anchor(0, 0).pos(78, 68).size(25, 25).color(100, 100, 100, 100);
        bg.addlabel(str(scene.user["crystal"]), "fonts/heiti.ttf", 20).anchor(0, 50).pos(207, 80).color(100, 100, 100);

        temp = bg.addsprite("crystal.png").anchor(0, 0).pos(179, 69).size(25, 24).color(100, 100, 100, 100);
        bg.addlabel(str(scene.user["winScore"]), "fonts/heiti.ttf", 20).anchor(0, 50).pos(304, 79).color(100, 100, 100);
        temp = bg.addsprite("dialogRankCup.png").anchor(0, 0).pos(278, 69).size(25, 22).color(100, 100, 100, 100);

        bg.addlabel(getStr("challengeReward", null), "fonts/heiti.ttf", 15).anchor(0, 50).pos(33, 80).color(100, 100, 100);
