...
temp = bg.addsprite("dialogBoss.png", ARGB_8888).anchor(0, 0).pos(517, 196).size(150, 166).color(100, 100, 100, 100);
        ...
        but0.bg.pos(492, 365);
        addChild(but0);
temp = bg.addsprite("roundFail.png", ARGB_8888).anchor(50, 50).pos(415, 90).color(100, 100, 100, 100);
temp = bg.addsprite("roundTip.png", ARGB_8888).anchor(0, 0).pos(206, 139).size(64, 47).color(100, 100, 100, 100);
bg.addlabel(str(param["score"]), getFont(), 20).anchor(0, 50).pos(413, 288).color(98, 2, 11);
temp = bg.addsprite("dialogRankCup.png", ARGB_8888).anchor(0, 0).pos(378, 277).size(31, 26).color(100, 100, 100, 100);
    }
    function onBack()
    {
