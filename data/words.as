...
["effectLevel", "复活等级小于"],
["unlimit", "无限"],
["dearKing", "   哼哼！尊敬的国  王陛下,快把公主交   出来吧！"],
...
["robCrystal", "[NAME]挑战你成功，抢走[SIL]银币, [CRY]水晶 [YEAR]/[MON]/[DAY] [HOUR]:[MIN]"],
...
["inTransferNoWar", "转职中该士兵不能参与战斗"],
["transferSoldier", "士兵转职"],
["transferTime", "转职时间：[TIME] "],
["transferBenefit", "攻击力+[ATT]\n防御力+[DEF]\n生命值+[HEALTH]\n暴击率+[CRITICAL]%\n闪避+[MISS]%\n攻击速度提升\n攻击距离提升"],
["transferLeftTime", "转职剩余时间 [TIME]"],
["inCalling", "正在招募[NAME]\n剩余时间 [TIME]"],
["callOn", "继续招募"],
["waitCall", "等待招募[NAME]\n等待时间 [TIME]"],
["callingSol", "招募中..."],
["callInQueue", "等待招募[NUM]"],
["deadSols", "阵亡士兵：[NAMES]"],
