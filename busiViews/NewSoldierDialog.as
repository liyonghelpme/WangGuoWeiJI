...
temp = bg.addsprite("dialogSoldierTitle.png", ARGB_8888).anchor(50, 50).pos(514, 113).color(100, 100, 100, 100);
temp = bg.addsprite("dialogSoldier.png", ARGB_8888).anchor(0, 0).pos(73, 11).color(100, 100, 100, 100);
