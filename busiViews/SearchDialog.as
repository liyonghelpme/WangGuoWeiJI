class SearchDialog extends MyNode
{
    ...
    function SearchDialog()
    {
        bg = node();
        init();
        bg.addsprite("back.png").anchor(0, 0).pos(186, 134).size(448, 237).color(100, 100, 100, 100);
        bg.addsprite("parchment.png").anchor(0, 0).pos(198, 160).size(422, 207).color(100, 100, 100, 100);
        ...
        but0.bg.pos(513, 368);
        addChild(but0);
        bg.addsprite("searchPeople.png").anchor(0, 0).pos(236, 210).size(87, 91).color(100, 100, 100, 100);
    }
