class SettingDialog extends MyNode
{
    ...
    function initView()
    {
        ...
        temp = bg.addsprite("settingDown.png").anchor(0, 0).pos(177, 276).size(464, 96).color(100, 100, 100, 100);
        temp = bg.addsprite("settingUp.png").anchor(0, 0).pos(177, 178).size(464, 62).color(100, 100, 100, 100);
        bg.addlabel(getStr("emailAddress", null), "fonts/heiti.ttf", 18).anchor(0, 50).pos(332, 345).color(37, 38, 39);
        bg.addlabel(getStr("caesarGameStudio", null), "fonts/heiti.ttf", 22).anchor(0, 50).pos(331, 313).color(43, 25, 9);
        temp = bg.addsprite("workshopLogo.png").anchor(0, 0).pos(188, 285).size(126, 79).color(100, 100, 100, 100);
        bg.addlabel(getStr("soundAndMusic", null), "fonts/heiti.ttf", 22).anchor(0, 50).pos(190, 210).color(43, 25, 9);
        bg.addlabel(getStr("developer", null), "fonts/heiti.ttf", 18).anchor(0, 50).pos(184, 259).color(66, 46, 28);
        bg.addlabel(getStr("sound", null), "fonts/heiti.ttf", 18).anchor(0, 50).pos(183, 160).color(66, 46, 28);
