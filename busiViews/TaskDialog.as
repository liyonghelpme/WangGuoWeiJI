...
panel.addlabel(replaceStr(taskData["des"], ["[NUM]", str(getCycleStageNum(tid, tData["stage"]))]), getFont(), 15).anchor(0, 50).pos(92, 51).color(56, 54, 53);
...
panel.addlabel(replaceStr(taskData["des"], ["[NAME]", getData(taskData["onceTaskId"], OnceTask[taskData["onceTaskId"]][stage])["name"]]), getFont(), 15).anchor(0, 50).pos(92, 51).color(56, 54, 53);
            ...
            } else if(kind == SOL_TASK)
            {
                ...
                {
temp = panel.addlabel(getStr("solTaskFinish", null), getFont(), 18, FONT_NORMAL, 90, 0, ALIGN_LEFT).anchor(0, 0).pos(389, 19).color(56, 54, 53);
                }
...
panel.addlabel(taskData["title"], getFont(), 23).anchor(0, 50).pos(94, 17).color(0, 0, 0);
                if(stage < len(taskSoldier))
panel.addlabel(replaceStr(taskData["des"], ["[NAME]", getData(SOLDIER, taskSoldier[stage])["name"]]), getFont(), 15).anchor(0, 50).pos(92, 51).color(56, 54, 53);
...
panel.addlabel(taskData["title"], getFont(), 23).anchor(0, 50).pos(94, 17).color(0, 0, 0);
panel.addlabel(taskData["des"], getFont(), 15).anchor(0, 50).pos(92, 51).color(56, 54, 53);
                reward = getGain(TASK, tid).items(); 
            }
