...
class BuildLand extends MyNode
{
    ...
    {
        map = m;
bg = sprite("land1.jpg", getParam("landArgb"), ARGB_8888).pos(1000, 1120).anchor(0, 100);
        init();
...
{   
    ...
    {
        map = m;
bg = sprite("land2.jpg", getParam("landArgb"), ARGB_8888).pos(2000, 1120).anchor(0, 100);
        init();
...
class TrainLand extends MyNode
{
    ...
    {
        map = m;
bg = sprite("land0.jpg", getParam("landArgb"), ARGB_8888).pos(0, 1120).anchor(0, 100);
        init();
