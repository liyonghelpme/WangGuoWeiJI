class ScoreDialog extends MyNode
{
    function initView()
    {
        ...
        temp = bg.addsprite("scoreStar.png").anchor(0, 0).pos(233, 196).size(217, 38).color(100, 100, 100, 100);
        ...
        temp = bg.addsprite("leftBalloon.png").anchor(0, 0).pos(41, 73).size(136, 302).color(100, 100, 100, 100);
        temp = bg.addsprite("rightBalloon.png").anchor(0, 0).pos(666, 37).size(120, 343).color(100, 100, 100, 100);


        temp = bg.addsprite("princess.png").anchor(0, 0).pos(463, 156).size(212, 264).color(100, 100, 100, 100);
