class DailyReward extends MyNode
{
    function initView()
    {
        bg = node();
        ...
        bg.addlabel(getStr("dayReward", null), "fonts/heiti.ttf", 30).anchor(50, 50).pos(408, 93).color(32, 33, 40);
        bg.addlabel(getStr("dayRich", null), "fonts/heiti.ttf", 20).anchor(50, 50).pos(417, 147).color(43, 25, 9);
    ...
    function onShare()
    {
        doShare(getStr("shareDaily", ["[NAME]", global.user.name]), null, null, null, null);
    }
    function onOk()
    {
