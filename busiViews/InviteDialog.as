class InviteDialog extends MyNode
{
    ...
    function initView()
    {
        bg = node();
        init();
bg.addsprite("loginBack.png", ARGB_8888).anchor(50, 50).pos(399, 255).size(621, 324).color(100, 100, 100, 100);
bg.addsprite("inviteTitle.png", ARGB_8888).anchor(50, 50).pos(404, 126).color(100, 100, 100, 100);
