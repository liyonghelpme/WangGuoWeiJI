...
class UpgradeSkillDialog extends MyNode
{
    ...
    function UpgradeSkillDialog(s, sid, skid)
    {
        ...
        init();
bg.addlabel(getStr("upgradeSkill", null), "fonts/heiti.ttf", 30).anchor(50, 50).pos(264, 26).color(33, 34, 40);
...
scroll.addlabel(getStr("useStoneMagic", null), "fonts/heiti.ttf", 22).pos(252, 32).anchor(50, 50).color(27, 15, 4);
...
pan.addlabel(getStr("sucPos", ["[POS]", str(posi)]), "fonts/heiti.ttf", 18).pos(57, 20).anchor(50, 50).color(31, 17, 5);
