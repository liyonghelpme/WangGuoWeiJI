class RoleName extends MyNode
{
    ...
    function RoleName(s, sol)
    {
        ...
        inputView = v_create(V_INPUT_VIEW, global.director.disSize[0]/2-bSize[0]/2+141, global.director.disSize[1]/2-bSize[1]/2+115, 245, 45);
        var but = bg.addsprite("roleNameBut0.png").size(180, 65).pos(152, 265).anchor(50, 50).setevent(EVENT_TOUCH, randomName);
        but.addlabel(getStr("rand", null), null, 35).anchor(50, 50).color(100, 100, 100).pos(90, 32);
        but = bg.addsprite("roleNameBut0.png").size(180, 65).pos(370, 265).anchor(50, 50).setevent(EVENT_TOUCH, nameIt);
