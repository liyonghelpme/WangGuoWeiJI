class MyWarningDialog extends MyNode
{
    ...
    function MyWarningDialog(title, words, cb)
    {
        ...
        init();
bg.addlabel(title, "fonts/heiti.ttf", 30, FONT_BOLD).pos(243, 29).anchor(50, 50).color(0, 0, 0);
bg.addlabel(words, "fonts/heiti.ttf", 25, FONT_NORMAL, 263, 118, ALIGN_LEFT).pos(177, 86).color(0, 0, 0);
        ...
        if(callback == null)
        {
            but = bg.addsprite("roleNameBut0.png").size(145, 46).pos(251, 265).anchor(50, 50).setevent(EVENT_TOUCH, closeDialog);
