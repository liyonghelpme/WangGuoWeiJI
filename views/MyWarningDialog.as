class MyWarningDialog extends MyNode
{
    ...
    function MyWarningDialog(title, words, cb)
    {
        ...
        init();
        bg.addlabel(title, null, 30, FONT_BOLD).pos(243, 29).anchor(50, 50).color(0, 0, 0);
        bg.addlabel(words, null, 25, FONT_NORMAL, 263, 118, ALIGN_LEFT).pos(177, 86).color(0, 0, 0);
