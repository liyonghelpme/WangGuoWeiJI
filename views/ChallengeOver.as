class ChallengeOver extends MyNode
{
    ...
    function ChallengeOver(win, star, crystal, score,  m, levelUpSol)//reward,
    {
        map = m;
...
bg.addlabel(getStr("challengeScore", ["[NUM]", str(score)]), "fonts/heiti.ttf", 18).pos(83, 290).color(0, 0, 0);
