...
temp = bg.addsprite(ARGB_8888).pos(0, 480).anchor(0, 100).addaction(repeat(animate(1500, "lighting0.png", "lighting1.png", "lighting2.png", "lighting3.png", "lighting4.png", "lighting5.png", "lighting6.png", UPDATE_SIZE, ARGB_8888)));
