...
class UpgradeDialog extends MyNode
{
    ...
    function initView()
    {
        ...
        temp = bg.addsprite("smallBack.png").anchor(0, 0).pos(130, 97).size(541, 67).color(100, 100, 100, 100);
        temp = bg.addsprite("smallBack.png").anchor(0, 0).pos(159, 45).size(484, 62).color(100, 100, 100, 100);
        words = bg.addlabel(getStr("stoneLevel", null), "fonts/heiti.ttf", 19).anchor(50, 50).pos(405, 363).color(100, 100, 100);
        ...
        but0.bg.pos(545, 417);
        addChild(but0);
        bg.addlabel(getStr("equipHighLevel", null), "fonts/heiti.ttf", 20).anchor(50, 50).pos(396, 135).color(43, 25, 9);
        bg.addlabel(getStr("upgradeEquip", null), "fonts/heiti.ttf", 33).anchor(50, 50).pos(392, 78).color(32, 33, 40);
        ...
        for(var i = 0; i < 4; i++)
        {
            ...
            temp = bg.addsprite("whiteBox.png").anchor(0, 0).pos(CURX, CURY).size(109, 153).color(100, 100, 100, 100);
