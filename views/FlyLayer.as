class FlyLayer extends MyNode
{
    ...
    function FlyLayer(s){
        ...
        jz.addlabel(getStr("mapAll"),null,33).anchor(50,50).pos(75,22).color(0,0,0,100);
        for(var i=0;i<=5;i++){
            jz = bg.addsprite("map_label_small.png").size(100,30).anchor(0,0).pos(labelPos[i]);
            jz.addlabel(getStr("mapIsland"+str(i)),null,22).anchor(50,50).pos(50,15).color(0,0,0,100);
        }
    }
}
