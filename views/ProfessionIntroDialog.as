...
bg.addlabel(getStr("solIntro", ["[NAME]", data.get("name")]), "fonts/heiti.ttf", 30, FONT_BOLD).pos(243, 29).anchor(50, 50).color(0, 0, 0);

        var des = soldierDes.get(data.get("desId"));
        des = getStr(des, null);
bg.addlabel(des, "fonts/heiti.ttf", 18, FONT_NORMAL, 287, 118, ALIGN_LEFT).pos(142, 84).color(0, 0, 0).anchor(0, 0);
...
but.addlabel(getStr("sureToBuy", null), "fonts/heiti.ttf", 25).anchor(50, 50).color(100, 100, 100).pos(72, 23);
