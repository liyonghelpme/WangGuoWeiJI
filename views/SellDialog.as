class SellDialog extends MyNode
{
    ...
    function SellDialog(o)
    {
        ...
        bg.addlabel(getStr("sellTitle", null), null, 30, FONT_BOLD).pos(243, 29).anchor(50, 50).color(0, 0, 0);
        bg.addlabel(getStr("sellContent", ["[NAME]", sellObj.data.get("name")]), null, 25, FONT_NORMAL, 263, 118, ALIGN_LEFT).pos(177, 86).color(0, 0, 0);
